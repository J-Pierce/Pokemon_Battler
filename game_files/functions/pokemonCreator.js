...
const pokemonList = {
  ...
  Flareon: new Fire("Flareon", 65, 20, "Fire blast", critChance, critModifier),
  Vaporeon: new Water(
    "Vaporeon",
    70,
    19,
  ...
  Leafeon: new Grass("Leafeon", 65, 17, "Giga drain", critChance, critModifier),
  Charmander: new Fire(
    "Charmander",
    44,
    17,
...
function pokemonByType() {
  return Object.groupBy(Object.values(pokemonList), (pokemon) => pokemon.type);
}
